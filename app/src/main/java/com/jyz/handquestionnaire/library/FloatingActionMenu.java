 ...
 */
package com.jyz.handquestionnaire.library;
...
public class FloatingActionMenu {
    ...
    /** Reference to the preferred {@link MenuAnimationHandler2} object */
    ...
    public FloatingActionMenu(final View mainActionView,
                              ...
                              MenuAnimationHandler2 animationHandler,
                              boolean animated,
...
//        this.mainActionView.setOnClickListener(new ActionViewClickListener());
     ...
     * @param animated if true, this action is executed by the current {@link MenuAnimationHandler2}
     */
    public void open(boolean animated) {
        ...
        if(animated && animationHandler != null) {
            // If animations are enabled and we have a MenuAnimationHandler2, let it do the heavy work
            ...
            for (int i = 0; i < subActionItems.size(); i++) {
                ...
                if(systemOverlay) {
                    ...
                    params.setMargins(center.x - subActionItems.get(i).width / 2, center.y - subActionItems.get(i).height / 2, 0, MyUtil.toDip(100));
                }
                addViewToCurrentContainer(subActionItems.get(i).view, params);
            }
            // Tell the current MenuAnimationHandler2 to animate from the center
            ...
            for (int i = 0; i < subActionItems.size(); i++) {
                ...
                if(systemOverlay) {
                    ...
                    params.setMargins(subActionItems.get(i).x, subActionItems.get(i).y, 0, MyUtil.toDip(100));
                    subActionItems.get(i).view.setLayoutParams(params);
    ...
    /**
     * Toggles the menu
     * @param animated if true, the open/close action is executed by the current {@link MenuAnimationHandler2}
     */
    ...
    private Point calculateItemPositions() {
        ...
        for(int i=0; i<subActionItems.size(); i++) {
            ...
            subActionItems.get(i).y = (int) coords[1] - subActionItems.get(i).height;
        }
        return center;
    }
    ...
    public static class Builder {
        ...
        public Builder(Context context, boolean systemOverlay) {
            ...
            // Default settings
            radius = context.getResources().getDimensionPixelSize(MyUtil.toDip(96));
            startAngle = 180;
            endAngle = 270;
            animationHandler = new DefaultAnimationHandler2();
            animated = true;
            this.systemOverlay = systemOverlay;
        }
        ...
        /**
         * Sets the current animation handler to the specified MenuAnimationHandler2 child
         * @param animationHandler a MenuAnimationHandler2 child
         * @return the builder object itself
         */
        public Builder setAnimationHandler(MenuAnimationHandler2 animationHandler) {
            this.animationHandler = animationHandler;
            return this;
        }
