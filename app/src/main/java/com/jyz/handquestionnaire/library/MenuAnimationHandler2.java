 ...
 */
public abstract class MenuAnimationHandler2 {
    ...
    public void animateMenuOpening(Point center) {
        if(menu == null) {
            throw new NullPointerException("MenuAnimationHandler2 cannot animate without a valid FloatingActionMenu.");
        }
